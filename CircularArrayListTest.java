...
/**
 * The test class CircularArrayListTest.
 *
 * @author  (your name)
...
{
    /**
     * Default constructor for test class CircularArrayListTest
     */
    public CircularArrayListTest()
    {
    }
    ...
    {
        CircularArrayList<String> circular2 = new CircularArrayList<String>();
        circular2.add("1");
        circular2.add("2");
        circular2.add("3");
        circular2.add("4");
